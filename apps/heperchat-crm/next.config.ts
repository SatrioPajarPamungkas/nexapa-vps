...
const SECURITY_HEADERS = [
  ...
  },
  {
    ...
    value: [
      ...
      "font-src 'self' data:",
      // Supabase REST + realtime (WSS). The Meta SDK performs its own
      // browser-side login/session calls; Graph API token exchange and
      // asset operations still happen only on our server.
