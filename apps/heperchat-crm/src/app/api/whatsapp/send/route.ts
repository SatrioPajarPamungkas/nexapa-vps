...
export async function POST(request: Request) {
  console.log('[whatsapp/send] POST received')
  try {
    ...
    console.log('[whatsapp/send] request body:', {
      ...
      has_content_text: !!body.content_text,
    })
    const {
    ...
    if (conversationIdInput) {
      console.log('[whatsapp/send] stage: lookup conversation start', {
        conversationIdInput,
        accountId,
      })
      ...
      console.log('[whatsapp/send] stage: conversation resolved', {
        conversationId,
      })
    } else {
    ...
    try {
      console.log('[whatsapp/send] stage: calling sendMessageToConversation', {
        conversationId,
        messageType: message_type,
      })
      ...
      console.log('[whatsapp/send] stage: sendMessageToConversation success', {
      ...
      if (err instanceof SendMessageError) {
        console.error(
          '[whatsapp/send] SendMessageError:',
          {
            code: err.code,
            status: err.status,
            message: err.message,
