    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      <header className="border-b border-white/10 bg-zinc-950/90">
        <div className="mx-auto flex h-16 max-w-[1500px] items-center justify-between px-6">
          <div className="flex items-center gap-3"><div className="rounded-lg bg-violet-600 p-2"><ShieldCheck className="size-5" /></div><div><div className="font-semibold">HeperChat Control Center</div><div className="text-xs text-zinc-500">Platform administration</div></div></div>
